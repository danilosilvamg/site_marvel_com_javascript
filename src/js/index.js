...
personagens.forEach((personagem) => {
    personagem.addEventListener('mouseenter',() =>{
        ...
        temos que:
        -colocar a classe selecionado no personagem que passamos o 
        mouse em cima para adicionar a animacao nele
        ...
        da listagem,trocar a imagem e nome do personagem grande
